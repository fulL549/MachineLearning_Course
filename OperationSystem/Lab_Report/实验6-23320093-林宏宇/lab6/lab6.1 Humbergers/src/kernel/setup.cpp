...
void a_mother(void *arg)
{
    ...
    printf("LinHongYumother: start to make cheese burger, there are %d cheese burger now\n", cheese_burger);
    // make 10 cheese_burger
    cheese_burger += 10;

    printf("LinHongYumother: oh, I have to hang clothes out.\n");
    // hanging clothes out
    delay = 0xfffffff;
    while (delay)
        --delay;
    ...
    printf("LinHongYumother: Oh, Jesus! There are %d cheese burgers\n", cheese_burger);
}

void a_naughty_boy(void *arg)
{
    printf("LinHongYuboy   : Look what I found!\n");
