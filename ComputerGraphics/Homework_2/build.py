...
# 项目根目录
project_root = Path(r"{str(self.project_root).replace(chr(92), chr(92)*2)}")

a = Analysis(
    [r'{str(self.project_root / self.main_script).replace(chr(92), chr(92)*2)}'],
    pathex=[r'{str(self.project_root).replace(chr(92), chr(92)*2)}'],
    binaries=[],
    datas=[
        # 如果有其他资源文件，在这里添加
